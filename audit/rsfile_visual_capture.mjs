...
function html(url) {
  ...
  <style>body{margin:0;background:#090909;color:#fff;font-family:Arial,sans-serif}.admin-layout{min-height:100vh;display:block}.admin-layout main{min-width:0}.toolbar,.upload,.panel,header{padding:12px}.list{display:grid}.file{display:flex;align-items:center;gap:10px;padding:16px 12px;border-bottom:1px solid #222;color:#fff;text-decoration:none}.fname{display:grid;flex:1}.more{margin-left:auto;width:40px;height:40px}</style></head><body>
  ...
  <div id="rsGlobalMenu" class="rs-global-menu" aria-hidden="true"><button class="rs-menu-backdrop" type="button" aria-label="Fechar menu" onclick="rsMenuToggle(false)"></button><div class="rs-menu-panel"><div class="rs-menu-title"><b>RS Storage</b><small>V4.7.13 · admin</small></div><nav aria-label="Navegação principal"><a href="/admin/files">Ficheiros</a><a href="/cinema">RS Cinema</a><a href="/ai">RS IA</a><a href="/admin/clients">Clientes</a></nav><form><button class="rs-menu-logout" type="button">Sair</button></form></div></div>
